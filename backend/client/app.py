...
@app.route('/send_google_form', methods=['POST'])
def send_google_form():
    obj = request.json
    res = requests.post("https://script.google.com/macros/s/AKfycbzNT3dOWdGU4Fy_UVx9QeD_Ute3HJNETf8ZHEgwdymMGUOLkB0m/exec", json=obj, headers={'Content-Type':'application/json'})
